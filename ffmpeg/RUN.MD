...
ffmpeg -f x11grab -r 10 -s 1280x720 -i :0.0+0,0 -preset superfast -tune zerolatency -pix_fmt yuv420p -c:v libx264 -c:a aac -r 10 -b:v 2M -b:a 128k -f flv rtmp://192.168.2.4:1935/live/1
