...
services:
  photoprism:
    ...
    environment:
      PHOTOPRISM_ADMIN_USER: "haoshuai"                 # superadmin username
      PHOTOPRISM_ADMIN_PASSWORD: "19920105"          # initial superadmin password (minimum 8 characters)
    ...
    volumes:
      ...
      - "~/family:/photoprism/originals/family" # *Additional* media folders can be mounted like this
